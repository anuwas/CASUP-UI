...
private baseUrl = '';
 ...
 constructor(private http:HttpClient) { 
  ...
  getAllScheduledTaskActivityByTaskId(taskId: number): Observable<Object> {
    return this.http.get(`${this.baseUrl}/all-scheduled-task-activity-list/${taskId}`);
  }
  ...
  createScheduledTaskActivity(userTaskSchedulerActivity: object): Observable<object> {
    return this.http.post(`${this.baseUrl}`+'/save-scheduled-task-activity', userTaskSchedulerActivity);
  }
