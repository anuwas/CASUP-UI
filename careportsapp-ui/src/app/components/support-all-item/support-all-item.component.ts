...
allAppConfPropSupItemType : any = [];
  ...
  loadPageConfiguration(){
    this.allAppConfPropSupItemType = GlobalConstants.getAllSupItemType();
    ...
    */
    ...
    rca_document_status:new FormControl(''),
    rca_shared_date:new FormControl(''),
  });
  ...
  itemsearchform = new FormGroup({
    ...
    this.item.rcaDocument=this.RCASharedStatus.value;
    this.item.documentSharedDate=this.RCASharedDate.value;
  ...
  setTimeout(function() { 
    ...
    getUpdateItem(itemid){
        ...
        item_close_date:new Date(this.UpdatableItem(data,'itemCloseDate')),
         ...
         rca_document_status:this.UpdatableItem(data,'rcaDocument'),
         rca_shared_date:this.UpdatableItem(data,'documentSharedDate'),
...
getOperationColorClass(itemObject : Object){
  ...
  get RCASharedStatus(){
    return this.itemsaveform.get('rca_document_status');
  }

  get RCASharedDate(){
    return this.itemsaveform.get('rca_shared_date');
  }
